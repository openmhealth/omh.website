...
// Add a filter to twentyeleven_header_image_width and twentyeleven_header_image_height to change these values.
        define('HEADER_IMAGE_WIDTH', apply_filters('twentyeleven_header_image_width', 670));
        define('HEADER_IMAGE_HEIGHT', apply_filters('twentyeleven_header_image_height', 490));
...
function twentyeleven_continue_reading_link() {
    return ' <a class="moreLink" href="' . esc_url(get_permalink()) . '">' . __('More <span class="doubleGt">&gt;&gt;</span>', 'twentyeleven') . '</a>';
}
...
if (!function_exists('twentyeleven_comment')) :
    ...
    class omh_events extends WP_Widget {

        function omh_events() {
            parent::WP_Widget(false, 'OMH Events');
        }
        ...
        function widget($args, $instance) {
            global $post;
            $tmp_post = $post;
            $q_args = array('numberposts' => 1, 'category' => 14);
            $myposts = get_posts($q_args);
            ?>
            <div class='postWidget events' style='display:none'>
                <h2>Upcoming Events</h2>
                <ul class='postWidget'>
                    <?php
                    foreach ($myposts as $post) : setup_postdata($post);
                        ?>
                        <li class="featuredProject">
                            <div class="title">
    ...
    class omh_featured_project extends WP_Widget {

        function omh_featured_project() {
            parent::WP_Widget(false, 'OMH Featured Project');
        }
...
class omh_contributors extends WP_Widget {

    function omh_contributors() {
        parent::WP_Widget(false, 'OMH Contributors');
    }
...
class omh_latest_posts extends WP_Widget {

    function omh_latest_posts() {
        parent::WP_Widget(false, 'OMH Latest Posts');
    }
...
class omh_featured_project_titles extends WP_Widget {

    function omh_featured_project_titles() {
        parent::WP_Widget(false, 'OMH Featured Project Titles');
    }
...
class more_contributors extends WP_Widget {

    function more_contributors() {
        parent::WP_Widget(false, 'More Contributors');
    }
...
class applications extends WP_Widget {

    function applications() {
        parent::WP_Widget(false, 'applications');
    }
...
class semiFooterWidget extends WP_Widget {

    function semiFooterWidget() {
        parent::WP_Widget(false, 'semiFooterWidget');
    }
